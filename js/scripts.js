document.addEventListener('DOMContentLoaded', function(){
	...
	equalSlideHeight('.big-photos-slider');
	...
	$('.proposals-slider').slick({
		...
		arrows: false,
		dots: true,
		appendDots: $('.proposals-slider-dots'),
		infinite: true
	});
	...
	function hideModal(modal){
		...
		$(modal).find('.video-iframe').remove();
	}
	...
	$('.video-block').click(function(e){
		...
		let modalId = "#video-modal";

		$('#video-modal .modal-video').append('<div class="video-iframe" id="'+videoId+'"></div>');
		createVideo(videoId);
...
objectFitImages('.big-slider .section-image img');
objectFitImages('.direction-card img');
objectFitImages('.article-card .card-image img');
objectFitImages('.video-block .video-preview');
